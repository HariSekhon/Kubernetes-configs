...
- Secrets - [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) `sealed-secrets-*.yaml`, or [External Secrets](https://github.com/external-secrets/external-secrets) integration to AWS Secrets Manager, GCP Secret Manager etc. - `external-secrets-*.yaml`
